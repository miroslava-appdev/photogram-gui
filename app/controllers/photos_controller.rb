class PhotosController < ApplicationController
  ...
  def update
    # Parameters: {"query_image"=>"https://robohash.org/dolorehicincidunt.png?size=300x300&set=set1", "query_caption"=>"Once you’ve accepted your flaws, no one can use them against you. Updated", "modify_id"=>"777"}
